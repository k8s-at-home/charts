...
![Version: 5.4.0](https://img.shields.io/badge/Version-5.4.0-informational?style=flat-square) ![AppVersion: 3.3.3](https://img.shields.io/badge/AppVersion-3.3.3-informational?style=flat-square)
...
helm repo update
helm install xbackbone k8s-at-home/xbackbone
```
...
```console
helm install xbackbone k8s-at-home/xbackbone -f values.yaml
```
...
A historical overview of changes can be found on [ArtifactHUB](https://artifacthub.io/packages/helm/k8s-at-home/xbackbone?modal=changelog)
