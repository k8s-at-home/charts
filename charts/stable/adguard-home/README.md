...
|-----|------|---------|-------------|
| args[0] | string | `"--config /opt/adguardhome/conf/AdGuardHome.yaml"` |  |
| args[1] | string | `"--no-check-update"` |  |
...
| initContainers[0].command[3] | string | `"/opt/adguardhome/conf/staging.yaml"` |  |
| initContainers[0].command[4] | string | `"/opt/adguardhome/conf/AdGuardHome.yaml"` |  |
...
| initContainers[0].volumeMounts[0].mountPath | string | `"/opt/adguardhome/conf/staging.yaml"` |  |
| initContainers[0].volumeMounts[0].name | string | `"adguard-home-config"` |  |
| initContainers[0].volumeMounts[0].subPath | string | `"staging.yaml"` |  |
