...
![Version: 3.0.0](https://img.shields.io/badge/Version-3.0.0-informational?style=flat-square) ![AppVersion: v0.102.0](https://img.shields.io/badge/AppVersion-v0.102.0-informational?style=flat-square)
...
| persistence.work.emptyDir.enabled | bool | `false` |  |
| persistence.work.enabled | bool | `false` |  |
| persistence.work.mountPath | string | `"/opt/adguardhome/work"` |  |
