...
* <https://github.com/shinobi/shinobi-docker>
...
|-----|------|---------|-------------|
| env | object | See below | environment variables. See more environment variables in the [shinobi documentation](https://shinobi.org/docs). |
| env.TZ | string | `"UTC"` | Set the container timezone |
| image.pullPolicy | string | `"IfNotPresent"` | image pull policy |
| image.repository | string | `"shinobi/shinobi"` | image repository |
