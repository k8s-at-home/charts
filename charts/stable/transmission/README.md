...
|------------|------|---------|
| https://library-charts.k8s-at-home.com | common | 3.2.1 |
...
- **BREAKING**: Upgraded the common library dependency to version 3.2.1. This introduces several breaking changes (`service`, `ingress` and `persistence` keys have been refactored).
  Be sure to check out the [library chart](https://github.com/k8s-at-home/library-charts/blob/common-3.2.1/charts/stable/common/) for the up-to-date values.
