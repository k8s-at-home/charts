...
- Migrate to common chart v3.1.1. Whilst this is a breaking change for many, it should be non-impactful for this app given there are no service or ingress definitions.
