...
![Version: 1.0.0](https://img.shields.io/badge/Version-1.0.0-informational?style=flat-square) ![AppVersion: 1.0.20210424](https://img.shields.io/badge/AppVersion-1.0.20210424-informational?style=flat-square)
...
| env.KILLSWITCH_EXCLUDEDNETWORKS_IPV4 | string | `nil` | A separated list of IPv4 networks that will be excluded from the VPN/killswitch |
| env.KILLSWITCH_EXCLUDEDNETWORKS_IPV6 | string | `nil` | A separated list of IPv6 networks that will be excluded from the VPN/killswitch |
| env.SEPARATOR | string | ; | The separator that is used to split the KILLSWITCH_EXCLUDEDNETWORKS lists |
